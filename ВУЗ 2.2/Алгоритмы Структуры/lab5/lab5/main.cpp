...
int main() {
    ...
    for(int size : sizes){
        ...
        std::cout << "В массиве размером " << size << " в среднем :\n" <<
            "Линейный поиск: " << mediumLinearComparisonCount << " количество сравнений, " << mediumLinearTimeSpent << " микросекунд прошло\n" <<
            "Барьер: " << mediumBarrierComparisonCount << " количество сравнений, " << mediumBarrierTimeSpent << " микросекунд прошло\n" <<
            "Бинарный поиск: " << mediumBinaryComparisonCount << " количество сравнений, " << mediumBinaryTimeSpent << " микросекунд прошло\n";
